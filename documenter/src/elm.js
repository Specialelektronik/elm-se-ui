...
var $author$project$Main$createFile = _Platform_outgoingPort(
	'createFile',
	function ($) {
...
var $author$project$Main$Module = F3(
	function (name, comment, values) {
		return {comment: comment, name: name, values: values};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $author$project$Main$Function = F3(
	function (name, comment, type_) {
		return {comment: comment, name: name, type_: type_};
	});
var $elm$json$Json$Decode$map3 = _Json_map3;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$functionDecoder = A4(
...
var $author$project$Main$build = function () {
	var modules = A2(
		$elm$core$Result$withDefault,
		_List_Nil,
		A2($elm$json$Json$Decode$decodeString, $author$project$Main$decoder, $author$project$Main$json));
	var imports = A2(
		$elm$core$String$join,
		'\n',
		A2(
			$elm$core$List$map,
			function (m) {
				return 'import ' + m.name;
			},
			modules));
	var template = A3($elm$core$String$replace, '{{imports}}', imports, 'module Docs exposing (main)\n\n{{imports}}\n');
	return $author$project$Main$createFile(
		{content: template, name: 'Docs.elm'});
}();
...
var $author$project$Main$main = $elm$core$Platform$worker(
	{
		init: function (_v0) {
			return _Utils_Tuple2(_Utils_Tuple0, $author$project$Main$build);
		},

...
var $author$project$Page$Home$init = _Utils_Tuple2(_Utils_Tuple0, $elm$core$Platform$Cmd$none);
		...
		var parser = $elm$url$Url$Parser$oneOf(
			_List_fromArray(
				[
					...
					A2($author$project$Main$stepHome, model, $author$project$Page$Home$init))
				]));
...
var $author$project$Page$notFound = {
...
var $author$project$SE$UI$Colors$darkest = A3($rtfeldman$elm_css$Css$rgb, 61, 72, 82);
...
var $author$project$SE$UI$Global$body = $rtfeldman$elm_css$Css$Global$body(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$color($author$project$SE$UI$Colors$darkest),
...
var $author$project$SE$UI$Global$code = A2(
	...
	_List_fromArray(
		[
			...
			A2($rtfeldman$elm_css$Css$property, 'font-family', 'monospace')
		]));
...
var $author$project$SE$UI$Global$fonts = A2(
	...
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, 'font-family', 'BlinkMacSystemFont, -apple-system, \"Segoe UI\", \"Roboto\", \"Oxygen\", \"Ubuntu\", \"Cantarell\", \"Fira Sans\", \"Droid Sans\", \"Helvetica Neue\", \"Helvetica\", \"Arial\", sans-serif')
		]));
...
var $author$project$SE$UI$Colors$lighter = A3($rtfeldman$elm_css$Css$rgb, 241, 245, 248);
var $rtfeldman$elm_css$Css$minWidth = $rtfeldman$elm_css$Css$prop1('min-width');
var $rtfeldman$elm_css$Css$optimizeLegibility = {textRendering: $rtfeldman$elm_css$Css$Structure$Compatible, value: 'optimizeLegibility'};
...
var $author$project$SE$UI$Global$html = $rtfeldman$elm_css$Css$Global$html(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$backgroundColor($author$project$SE$UI$Colors$lighter),
			$rtfeldman$elm_css$Css$fontSize(
...
var $author$project$SE$UI$Colors$lightest = A3($rtfeldman$elm_css$Css$rgb, 248, 250, 252);
...
var $author$project$SE$UI$Colors$danger = A3($rtfeldman$elm_css$Css$rgb, 255, 56, 96);
...
var $author$project$SE$UI$Colors$link = A3($rtfeldman$elm_css$Css$rgb, 50, 115, 220);
var $author$project$SE$UI$Colors$linkHover = A3($rtfeldman$elm_css$Css$rgb, 36, 102, 209);
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$color($author$project$SE$UI$Colors$link),
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Css$color($author$project$SE$UI$Colors$linkHover)
								]))
						])),
					$rtfeldman$elm_css$Css$Global$code(
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$backgroundColor($author$project$SE$UI$Colors$background),
							$rtfeldman$elm_css$Css$color($author$project$SE$UI$Colors$danger),
							$rtfeldman$elm_css$Css$fontSize(
							$rtfeldman$elm_css$Css$em(0.875)),
							$rtfeldman$elm_css$Css$fontWeight($rtfeldman$elm_css$Css$normal),
							A3(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$Global$selector('input[type=\"checkbox\"]'),
							$rtfeldman$elm_css$Css$Global$selector('input[type=\"radio\"]')
						]),
					_List_fromArray(
						[
...
var $author$project$Navbar$navbarHeight = $rtfeldman$elm_css$Css$rem(3.75);
var $rtfeldman$elm_css$Css$stretch = $rtfeldman$elm_css$Css$prop1('stretch');
var $author$project$Navbar$brandStyles = _List_fromArray(
	[
		...
		$rtfeldman$elm_css$Css$minHeight($author$project$Navbar$navbarHeight)
	]);
...
var $author$project$Navbar$navbarLinkColor = $author$project$SE$UI$Colors$darkest;
var $rtfeldman$elm_css$Css$position = $rtfeldman$elm_css$Css$prop1('position');
var $rtfeldman$elm_css$Css$relative = {position: $rtfeldman$elm_css$Css$Structure$Compatible, value: 'relative'};
var $author$project$Navbar$itemAndLinkStyles = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$color($author$project$Navbar$navbarLinkColor),
...
var $author$project$Navbar$brand = A4(
	$rtfeldman$elm_css$Html$Styled$styled,
	$rtfeldman$elm_css$Html$Styled$div,
	$author$project$Navbar$brandStyles,
	_List_Nil,
	_List_fromArray(
		[
			A4(
			...
			$author$project$Navbar$itemAndLinkStyles,
			_List_fromArray(
				[
...
var $author$project$Navbar$headerStyles = _List_fromArray(
	[
...
var $author$project$SE$UI$Utils$gap = 64;
var $author$project$SE$UI$Utils$desktopWidth = 960 + (2 * $author$project$SE$UI$Utils$gap);
...
var $author$project$Navbar$endStyles = _List_fromArray(
	[
...
var $author$project$Navbar$menuStyles = _List_fromArray(
	[
...
var $author$project$Navbar$startStyles = _List_fromArray(
	[
		$author$project$SE$UI$Utils$desktop(
		_List_fromArray(
			[
...
var $author$project$Navbar$menu = F2(
	function (startItems, endItems) {
		return A4(
			$rtfeldman$elm_css$Html$Styled$styled,
			$rtfeldman$elm_css$Html$Styled$div,
			$author$project$Navbar$menuStyles,
			_List_Nil,
			_List_fromArray(
				[
					A4($rtfeldman$elm_css$Html$Styled$styled, $rtfeldman$elm_css$Html$Styled$div, $author$project$Navbar$startStyles, _List_Nil, startItems),
					A4($rtfeldman$elm_css$Html$Styled$styled, $rtfeldman$elm_css$Html$Styled$div, $author$project$Navbar$endStyles, _List_Nil, endItems)
				]));
	});
var $rtfeldman$elm_css$Html$Styled$nav = $rtfeldman$elm_css$Html$Styled$node('nav');
var $author$project$SE$UI$Colors$white = A3($rtfeldman$elm_css$Css$rgb, 255, 255, 255);
var $author$project$Navbar$navStyles = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$backgroundColor($author$project$SE$UI$Colors$white),
		$rtfeldman$elm_css$Css$minHeight(
		$rtfeldman$elm_css$Css$rem(3.25)),
		$rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$relative),
		$rtfeldman$elm_css$Css$zIndex(
...
var $author$project$SE$UI$Colors$primary = A3($rtfeldman$elm_css$Css$rgb, 53, 157, 55);
var $author$project$Navbar$ribbonStyles = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$margin($rtfeldman$elm_css$Css$zero),
		$rtfeldman$elm_css$Css$height(
		$rtfeldman$elm_css$Css$px(4)),
		$rtfeldman$elm_css$Css$backgroundColor($author$project$SE$UI$Colors$primary)
	]);
var $author$project$Navbar$viewRibbon = A4($rtfeldman$elm_css$Html$Styled$styled, $rtfeldman$elm_css$Html$Styled$hr, $author$project$Navbar$ribbonStyles, _List_Nil, _List_Nil);
var $author$project$Navbar$view = A4(
	$rtfeldman$elm_css$Html$Styled$styled,
	$rtfeldman$elm_css$Html$Styled$header,
	$author$project$Navbar$headerStyles,
	_List_Nil,
	_List_fromArray(
		[
			A4(
			...
			$author$project$Navbar$navStyles,
			_List_fromArray(
				[
					A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'role', 'navigation'),
					A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'ariaLabel', 'main navigation')
				]),
			_List_fromArray(
				[
					$author$project$Navbar$brand,
					A2($author$project$Navbar$menu, _List_Nil, _List_Nil)
				])),
			$author$project$Navbar$viewRibbon
		]));
var $author$project$Page$viewFrame = function (content) {
	return A4(
		$rtfeldman$elm_css$Html$Styled$styled,
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('sidebar')
							])),
						A2($rtfeldman$elm_css$Html$Styled$div, _List_Nil, content)
					]))
			]));
};
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Home page!')
					]))
			]),
		title: 'Home'
	};
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		view: A2($elm$core$Basics$composeR, $author$project$Main$view, $author$project$Main$toUnstyled)
	});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"ClickedLink":["Browser.UrlRequest"],"ChangedUrl":["Url.Url"],"HomeMsg":["Page.Home.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Page.Home.Msg":{"args":[],"tags":{"NoOp":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});}(this));